...
const IDEAS = [
  "لوحة لمتابعة شرب الماء مع هدف يومي",
  "متتبّع مزاج أسبوعي مع أعمدة ونسبة إنجاز",
  "حاسبة قسط شهري لقرض",
  "قائمة مهام بأولويات وعدّاد منجز",
  "متتبّع قراءة: صفحات اليوم وهدف الأسبوع",
  "عدّاد تمارين مع راحة بين المجموعات",
];
