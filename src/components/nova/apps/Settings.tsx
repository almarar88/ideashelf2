    ...
    <div className="app scroll">
      ...
      <div className="card">
        ...
        <div className="dim" style={{ fontSize: 12.5, marginTop: 9, lineHeight: 1.75 }}>
          {edition === "device"
            ? "نسخة الجهاز تعمل بطبقة الانعكاس المحلية بالكامل: لا شبكة، لا مفتاح، ولا خادم. النوافذ والملفات والأسطح والصلاحيات وتوليد التطبيقات والوكلاء والإرجاع الزمني تعمل كلها هنا. ما يحتاج خادمًا — تخطيط Claude الحر — غائب بحكم التصميم لا بخلل."
            : neural
